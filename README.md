...
2024.03 ~ current<br>
<span style="display: block; line-height: 1.1; font-size: 10px; margin-left: 40px;">Led a project to develop a vision-based worker access verification system optimized for AI boards (Samsung Heavy Industries-PNU Collaborative Project).<br>Conducting research on UWB and Two-Way-Ranging based RTLS.<br>
Developing Real-Time Operating System for robotic applications.  </span>
